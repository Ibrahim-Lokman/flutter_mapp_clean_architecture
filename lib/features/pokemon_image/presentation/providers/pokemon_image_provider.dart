...
import 'package:poke_mapp/features/pokemon/business/entities/pokemon_entity.dart';
...
class PokemonImageProvider extends ChangeNotifier {
  ...
  void eitherFailureOrPokemonImage(
    ...
    // Creating the repository with remote, local data sources and network info
